...
(function () {
    ...
    const MT_ALL_TOOLS = [
        ...
        { id: 'typetijger', name: 'Typetijger', url: 'digitale-geletterdheid/typetijger', icon: '&#128047;' },
        { id: 'typrace', name: 'Typrace', url: 'digitale-geletterdheid/typrace', icon: '&#127939;' },
        // Educatieve games
        ...
        { id: '10-minuten-didactiek', name: '10-minuten-didactiek', url: 'lesmateriaal/10-minuten-didactiek', icon: '&#9201;&#65039;', uc: true },
        // Ontspanning
        ...
        { id: 'doelenbord', name: 'Doelenbord', url: 'groepsvorming/doelenbord', icon: '&#127919;' },
        { id: 'talentenwiel', name: 'Talentenwiel', url: 'groepsvorming/talentenwiel', icon: '&#11088;' },
        // Organisatie
